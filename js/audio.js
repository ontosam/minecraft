  ...
  play(name) {
    switch (name) {
      ...
      case 'boing': // springy bounce off a slime block
        ...
        break;
      case 'bow': // a soft twang when a skeleton looses an arrow
        this.blip(520, 0.12, 'triangle', 0.10, 180);
        break;
      case 'rattle': // gentle bony rattle (sillier than spooky)
        this.blip(140, 0.10, 'square', 0.05, 90);
        setTimeout(() => this.blip(120, 0.10, 'square', 0.045, 80), 70);
        break;
