...
const CORE = [
  ...
  'js/aliencops.js', 'js/astronaut.js', 'js/rover.js', 'js/dragonmount.js', 'js/rocketship.js', 'js/spacerace.js', 'js/legodreamzz.js', 'js/goals.js', 'js/character.js',
